...
DepartmentService DepartmentService = (DepartmentService) context.lookup("java:global/EPProject/DepartmentServiceImpl!com.klef.ep.services.DepartmentService");
