...
<body>
    <div class="container">
        ...
        <form method="post" action="profileupdate_std.jsp">
            <div class="form-group">
                <label for="id"><b>ID</b></label>
                <input type="number" id="id" name="id" value="<%=s.getId()%>" readonly required>
            </div>
            <div class="form-group">
            ...
            <div class="form-group">
                ...
                <input type="text" id="username" name="username" value="<%=s.getUsername()%>" required>
            </div>
            <div class="form-group">
            ...
            <div class="form-group">
                ...
                <input type="number" id="contact" name="contact" value="<%=s.getContact()%>" required>
            </div>
            <div class="form-group">
